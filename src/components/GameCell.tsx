  ...
  return (
    ...
    >
      {value && (
       ...
       {moveNumber && (
         <span className="absolute top-0.5 right-0.5 sm:top-1 sm:right-1 text-xs bg-white text-gray-800 rounded-full w-4 h-4 sm:w-5 sm:h-5 flex items-center justify-center font-bold shadow-md">
           {moveNumber}
         </span>
       )}
    </div>
